...
('Dar El Bhar', 'maison_dhotes', 'Traditional Tunisian guest house with authentic charm', 'Houmet Souk, Djerba', 80.00, 6, ARRAY['summer', 'spring', 'fall'], ARRAY['WiFi', 'Traditional Breakfast', 'Terrace', 'Garden'], 'https://images.unsplash.com/photo-1571896349842-33c89424de2d', 4.7),
...
('Dar Dhiafa', 'maison_dhotes', 'Intimate guesthouse with personalized service', 'Houmet Souk, Djerba', 65.00, 3, ARRAY['summer', 'spring', 'fall'], ARRAY['WiFi', 'Breakfast', 'Terrace', 'Local Experience'], 'https://images.unsplash.com/photo-1564501049412-61c2a3083791', 4.5);
